...
<body>
    <div class="container-fluid mt-3">
        <form action="#" method="post">
            ...
            <div class="container-fluid w-100 mt-3 x">
                <div class=" s ">
                    <table class="table t">
                        <thead class="">
                        ...
                        <tbody class="text-center">
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                if ($row['Status'] == 'Active') {
                                    echo "<a href='withdraw.php?id=$row[AccountID]' class='btn btn-info text-white btn-del ' id='BtnDelete'>Withdraw</a>";
                                } else {
                                    echo "<a href='withdraw.php?id=$row[AccountID]' class='btn disabled btn-info text-white btn-del ' id='BtnDelete'>Withdraw</a>";
                                }
                                echo "</td>";
                                echo "</td>";
                            }
